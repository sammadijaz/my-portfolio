...
function PageNavbar() {
  ...
  return (
    <>
      <nav
        ref={navRef}
        className="z-50 fixed flex flex-col justify-between gap-y-10 px-10 py-28 w-full h-full text-white/80 bg-black uppercase md:left-1/2 w-1/2"
      >
      ...
      {/* Burger Menu Button */}
      <div
        className="z-50 fixed top-4 right-10 flex flex-col items-center justify-center gap-1 w-14 h-14 bg-black rounded-full transition-all duration-300 cursor-pointer md:w-20 h-20"
        onClick={toggleMenu}
        style={
          showBurger
